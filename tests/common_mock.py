...
def client():
    ...
    obj.catalog.budget_versions.append(budget_version)
    obj.budget.master_categories.append(master_category)
    obj.budget.subcategories.append(subcategory)
    obj.budget.payees.append(payee)
    session.commit()
