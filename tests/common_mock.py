...
class TestCommonMock(unittest.TestCase):
    def setUp(self):
        ...
        self.client.catalog.budget_versions.append(budget_version)
        self.client.budget.master_categories.append(master_category)
        self.client.budget.subcategories.append(subcategory)
        self.client.budget.payees.append(payee)
        session.commit()
