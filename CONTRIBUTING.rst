...
When `reporting a bug <https://github.com/ionelmc/pynYNAB/issues>`_ please include:
...
pynYNAB could always use more documentation, whether as part of the
...
The best way to send feedback is to file an issue at https://github.com/ionelmc/pynYNAB/issues.
...
4. When you're done making changes, run the tests ::
