! function(e) {
    ...
    return t.e = function(e, r) {
        ...
        if (void 0 !== o[e]) o[e].push(r);
            ...
            i.type = "text/javascript", i.charset = "utf-8", i.async = !0, i.crossOrigin = "anonymous", i.src = t.p + "" + ({
                ...
                1: "d3b412b31f57e9b76cd9",
                2: "8ad9ce31c1488f8fd154",
                3: "60237f05dc5f9adb07a3",
                4: "1f97114bc568d9f5a75b",
                5: "2f6449815eb393005880",
                6: "d1156017ffb60fab0778",
                7: "1c3c06f3133044e7f30a",
                8: "649286c4e11d9536f58c"
    ...
    var n, o, i, a, s, u;
    if (o = document.getElementById("ynab_client_constants"), i = unescape(o.textContent || o.innerHTML), window.YNAB_CLIENT_CONSTANTS = JSON.parse(i), u = "v1.14655", console.log("%c%s", "color:red;font-size:4em;", "Stop!"), console.log("%c%s", "font-size:1.5em;", "The console is a browser feature intended for developers. If someone told you to copy-paste something here to enable a YNAB feature, it is a scam and will give them access to your YNAB account."), console.log("YNAB_VERSION: " + u), a = window.location.pathname, "/users/reset" !== a.slice(0, 12)) {
        if (s = {
                maxItems: 3,
                ...
                verbose: !1,
                captureUncaught: !0,
                enabled: "localhost" !== document.location.hostname,
                payload: {
                    client: {
                        javascript: {
                            code_version: u,
            ...
            }, n = r(2), n.init(s), r(3), "localhost" === document.location.hostname && sourceMapSupport.install(), function(e, t, r, n, o, i, a) {
            ...
            }(window, document, "script", "//www.google-analytics.com/analytics.js", "ga"), ga("create", YNAB_CLIENT_CONSTANTS.GA_TRACKING_ID, "auto"), ga("send", "pageview"), function() {
                function e() {
            ...
            }(), YNAB_CLIENT_CONSTANTS.ATTRIBUTION_PROJECT_ID) {
            window.Attribution = window.Attribution || [], window.Attribution.methods = ["trackSubmit", "trackClick", "trackLink", "trackForm", "pageview", "identify", "group", "track", "ready", "alias", "page", "once", "off", "on"], window.Attribution.factory = function(e) {
                return function() {
                    var t = Array.prototype.slice.call(arguments);
                    return t.unshift(e), window.Attribution.push(t), window.Attribution
                }
            };
            for (var c = 0; c < window.Attribution.methods.length; c++) {
                var l = window.Attribution.methods[c];
                window.Attribution[l] = window.Attribution.factory(l)
            }
            window.Attribution.load = function(e) {
                if (!document.getElementById("attribution-js")) {
                    var t = document.createElement("script");
                    t.type = "text/javascript", t.id = "attribution-js", t.async = !0, t.src = "//scripts.attributionapp.com/attribution.js";
                    var r = document.getElementsByTagName("script")[0];
                    r.parentNode.insertBefore(t, r)
                }
            }, window.Attribution.load(), Attribution.projectId = YNAB_CLIENT_CONSTANTS.ATTRIBUTION_PROJECT_ID, Attribution.page()
        }
    ...
    (this.define || function(e, t) {
        ...
        return function t(e, r, n) {
            ...
            3: [function(e, t, r) {
                ...
                function i(e, t, r, o) {
                    var i = n._charsWritten = F(R(t), e, r, o);
                    return i
                }

                function a(e, t, r, o) {
                    var i = n._charsWritten = F(B(t), e, r, o);
                    return i
                }
                ...
                function u(e, t, r, o) {
                    var i = n._charsWritten = F(j(t), e, r, o);
                    return i
                }

                function c(e, t, r, o) {
                    var i = n._charsWritten = F(U(t), e, r, o);
                    return i
                }
                ...
                r.Buffer = n, r.SlowBuffer = n, r.INSPECT_MAX_BYTES = 50, n.poolSize = 8192, n._useTypedArrays = function() {
                    ...
                    var r = this.length;
                    if (e = C(e, r, 0), t = C(t, r, r), n._useTypedArrays) return n._augment(this.subarray(e, t));
            ...
            20: [function(e, t, r) {
                (function(t, n) {
                    ...
                    function c(e) {
                        ...
                        if (!t) {
                            var r = u(e.source);
                            r && r.map && '{"error": "not_found"}' !== r.map ? (t = S[e.source] = {
                                url: r.url,
                                map: new v(r.map)
                    ...
                    function g(e, t) {
                        return E && (A = {}, S = {}), L ? e + t.map(function(e) {
                            return "\n    at " + h(e)
...
//# sourceMappingURL=before.d7d6da6ff37e0f1bd15e.js.map