...
from pynYnAB.ynab_api.models.accounts_response import AccountsResponse  # noqa: E501
...
class TestAccountsResponse(unittest.TestCase):
    ...
    def testAccountsResponse(self):
        ...
        # model = pynYnAB.ynab_api.models.accounts_response.AccountsResponse()  # noqa: E501
        pass
