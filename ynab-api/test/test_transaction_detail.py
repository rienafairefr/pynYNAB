...
from pynYnAB.ynab_api.models.transaction_detail import TransactionDetail  # noqa: E501
...
class TestTransactionDetail(unittest.TestCase):
    ...
    def testTransactionDetail(self):
        ...
        # model = pynYnAB.ynab_api.models.transaction_detail.TransactionDetail()  # noqa: E501
        pass
