...
from pynYnAB.ynab_api.models.month_detail_response import MonthDetailResponse  # noqa: E501
...
class TestMonthDetailResponse(unittest.TestCase):
    ...
    def testMonthDetailResponse(self):
        ...
        # model = pynYnAB.ynab_api.models.month_detail_response.MonthDetailResponse()  # noqa: E501
        pass
